...
class About extends Component {
  render() {
    return (
      <div className="about">
        <div id="summary">
          <p>Following an invigorating and reflective year of international travel, I was inspired towards change in my career endeavors and began carving a new path in post production. I wanted to help filmmakers tell their stories and began my journey to the editing chair.</p>
